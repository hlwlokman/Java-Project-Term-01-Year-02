...
public class ControlPanel extends VBox {
    ...
    public ControlPanel(Graphs graphs) {
        ...
        // Add a button to show the Grass Chart
        Button showGrassChartButton = new Button("Show Grass height over the year");
        showGrassChartButton.setOnAction(e -> GrassChart.showGrassChart());
        ...
        getChildren().addAll(
            ...
            showGrassChartButton // Add the new button here
        );
    }
}
